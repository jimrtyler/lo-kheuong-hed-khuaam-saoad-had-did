...
#GUI Variables
$FormTitleText = "Disk Cleaner ໂດຍ Jim Tyler (PowerShellEngineer.com)"
$SelectDiskLabelText = "ເລືອກ Disk:"
$FreeSpaceLabelText = "ພື້ນທີ່ຫວ່າງ (gigabytes):"
$TotalSpaceLabelText = "ພື້ນທີ່ທັງໝົດ (gigabytes):"
$JunkFoundLabelText = "ພົບຂີ້ເຫຍື້ອ (gigabytes):"
$CleanDiskBtnText = "Clean Disk *ລຶບໄຟລ໌*"
$SpaceCleanedLabelText = "ພື້ນທີ່ສະອາດ (ກິກາໄບ):"
$LogFileLabelText = "ພົບໄຟລ໌ບັນທຶກ: $abcdefg"
$CreditLabelText = "Script ໂດຍ Jim Tyler - PowerShellEngineer.com"
$LogFileLocatedText = "ພົບໄຟລ໌ບັນທຶກ"
$AnalyzingDriveText = "ການວິເຄາະ Drives..."
$BrowsersAreRunningText = "ບຣາວເຊີກຳລັງແລ່ນ... ແຈ້ງຜູ້ໃຊ້..."
$PleaseCloseBrowsersText = "ກະລຸນາປິດທຸກເວັບບຣາວເຊີ ແລະລອງໃໝ່ອີກ."
$CleaningDriveText = "ທຳຄວາມສະອາດ Drive..."
